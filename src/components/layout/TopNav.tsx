      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <div className="text-[11px] font-bold text-white leading-none">AGENCY OWNER</div>
            <div className="text-[8px] text-[#00D4FF] font-mono font-bold mt-0.5 tracking-widest">[ ACTIVE SESSION ]</div>
          </div>
